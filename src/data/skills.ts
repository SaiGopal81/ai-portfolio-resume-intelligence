...
export const skills: Skill[] = [
  ...
  { name: 'ADF', category: 'Data Engineering', description: 'Azure Data Factory — cloud-based ETL service for data integration and orchestration.', usedFor: ['Cloud ETL', 'Data Pipeline Orchestration', 'Data Movement', 'Workflow Automation'], relatedProjects: ['Fraud Detection Pipeline', 'Airport Operations Analytics'] },
